<?php
    ...
    $result = $gestoreDB->accettaInvito($username, $idGruppo);
    if($result)
    {
        $vettoreRitorno["status"] = "OK";
        $vettoreRitorno["msg"] = "Invito accettato con successo";
    }
    else
    {
        $vettoreRitorno["status"] = "ERR";
        $vettoreRitorno["msg"] = "Errore durante l'accettazione dell'invito";
    }
    print(json_encode($vettoreRitorno));
    return;
?>